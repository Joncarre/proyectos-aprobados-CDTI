    ...
    <div className="min-h-screen">
      ...
      <div className="flex">
        ...
        <button
          ...
          className="shadow-card fixed top-1/2 z-50 flex h-16 w-6 -translate-y-1/2 items-center justify-center rounded-r-lg border border-l-0 border-line bg-surface text-ink-soft transition-[left,background-color,color] duration-500 hover:bg-accent-soft hover:text-accent-strong"
        >
          <ChevronLeft
            className={cn('size-4 transition-transform duration-500', !filtersOpen && 'rotate-180')}
            style={{ transitionTimingFunction: PANEL_EASE }}
          />
        </button>
