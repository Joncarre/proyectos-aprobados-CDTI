...
| `GET /api/distribution`    | `ancho` (1\|2\|5\|10\|20\|25)                                                                                                     | Histograma del % de aportación (bins completos, también vacíos)                                                      |
...
| `GET /api/projects/export` | —                                                                                                                                 | Descarga CSV del conjunto filtrado completo (separador `;`, coma decimal, BOM UTF-8 — abre directo en Excel español) |
